...
class Person(object):
    ...
    def roles(self):
        ...
        return [self._cache['roles'][role_id] for role_id in role_ids]

    @property
    def groups(self):
        group_ids = (role['links']['group'] for role in self.roles)
    ...
    def __init__(self, json):
        ...
        for person in json['people']:
            ...
            for role_id in person['links']['roles']:
                ...
                self._list.append((role['label'] or role['role_type'], person_id))
